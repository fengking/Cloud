...
(1, NULL, '个人信息', 'http://localhost:8080/fkCloud/f/user_userinfo.html'),
(2, 1, '日志信息', 'http://localhost:8080/fkCloud/f/log_list.html'),
(3, 1, '表设计维护', 'http://localhost:8080/fkCloud/f/dbquery_list.html'),
(4, 1, '项目维护', 'http://localhost:8080/fkCloud/f/project_list.html'),
(5, 1, '表维护', 'http://localhost:8080/fkCloud/f/table_list.html'),
(6, 1, '个人信息', 'http://localhost:8080/fkCloud/f/user_userinfo.html'),
(7, NULL, '员工信息', 'http://localhost:8080/fkCloud/f/user_userinfo.html');
