...
<tr align="left" bgcolor="#FAFAF1">
	...
	<td width="35%"><select id="frame" class="easyui-combobox" name="iframecode" style="width:150px;" data-options="valueField:'iframecode',textField:'sframename',url:'${pageContext.request.contextPath}/frameComboAction.html'"></select>&nbsp;</td>
</tr>
</table>
</fieldset>
</form>
